	...
	if not filters.get("group_by_mr"):
		columns.extend(
			[
    			...
    			{"label": _("Item Category"), "fieldname": "item_category", "fieldtype": "Data", "width": 90},  # ✅ NEW
